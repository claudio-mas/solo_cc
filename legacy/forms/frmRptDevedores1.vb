Public Class frmRptDevedores1
    ...
    Private Sub frmRptDevedores1_Closed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
    ...
    Private Sub C1Report1_PrintSection(sender As System.Object, e As C1.C1Report.ReportEventArgs) Handles C1Report1.PrintSection
        ...
        Me.C1Report1.Fields("rtTitulo").Text = "Clientes devedores em " & frmReports.Dt.Value.ToShortDateString & " com saldo maior ou igual a " & FormatCurrency(frmReports.Saldo.Value, 2)
